...
MARKDOWN_TABLE_SPLITTER_PARAMS = {"split_table_rows": True, "max_rows_per_chunk": 3}
...
def run_example(client=None):
    ...
    try:
        ...
        print_section(section, "Load documents (excel loader -> markdown)")
        loaded = api.load_documents(document_version_id, loader_type="excel", loader_params={})
        ...
        print_section(section, "Create segments (markdown_table)")
        ...
        idx = api.create_index(project_id, "08_excel_md_basic", provider="chroma", config=INDEX_CONFIG)
