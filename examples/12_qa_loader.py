...
def run_example(client=None):
    ...
    try:
        ...
        upload = api.upload_document(artifacts["project_id"], docs_path("interview.txt"), "text/plain")
        ...
        print_section(section, "Create chunks (qa)")
        chunk = api.split_segment_set(artifacts["segment_set_version_id"], strategy="qa", splitter_params={})
